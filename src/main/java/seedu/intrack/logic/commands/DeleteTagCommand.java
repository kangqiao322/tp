...
public class DeleteTagCommand extends Command {
    ...
    public static final String DELETED_TAG_NOT_PRESENT = "There is one or more tags listed that are not in the list" +
            " of tags!";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Internship editedInternship = new Internship(internshipToEdit.getName(), internshipToEdit.getPosition(),
                ...
                internshipToEdit.getWebsite(), internshipToEdit.getTasks(), newTagList,
